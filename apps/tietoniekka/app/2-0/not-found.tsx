  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 12, marginTop: 26 }}>
        <a href="/2-0/kokoelmat" style={{ minHeight: 48, padding: "0 22px", borderRadius: 999, background: "var(--tn-lime, #B6FF3C)", color: "#0F0D07", fontWeight: 900, textTransform: "uppercase", display: "inline-flex", alignItems: "center" }}>
          Selaa kokoelmia →
        </a>
        <a href="/2-0" style={{ minHeight: 48, padding: "0 22px", borderRadius: 999, border: "1px solid #3A3122", color: "#F5F0E6", fontWeight: 700, display: "inline-flex", alignItems: "center" }}>
          Etusivulle
        </a>
      </div>
    </main>
