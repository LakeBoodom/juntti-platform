      ...
      <div className="tnl-shell">
        ...
        <section className="tnl-section" id="kaikki">
          ...
          <nav className="tn-chipnav tnl-filters" aria-label="Alakokoelmat">
            <a href="/kokoelma/luonto#kaikki" data-active={filter === "kaikki" || undefined}>Kaikki</a>
            {presentSubs.map((s) => (
              <a key={s.key} href={`/kokoelma/luonto?suodata=${s.key}#kaikki`} data-active={filter === s.key || undefined}>
                {s.label}
              </a>
            ))}
          </nav>
